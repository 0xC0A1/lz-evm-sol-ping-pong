...
/** InvalidBallLength:  */
export class InvalidBallLengthError extends ProgramError {
  override readonly name: string = 'InvalidBallLength';
...
codeToErrorMap.set(0x1770, InvalidBallLengthError);
nameToErrorMap.set('InvalidBallLength', InvalidBallLengthError);
...
codeToErrorMap.set(0x1771, InvalidMessageLengthError);
...
codeToErrorMap.set(0x1772, InvalidMessageTypeError);
