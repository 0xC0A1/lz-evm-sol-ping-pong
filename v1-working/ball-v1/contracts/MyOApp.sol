...
contract MyOApp is OApp, OAppOptionsType3 {
    ...
    /**
     * @notice Serves the ball to the destination chain.
    ...
    function send(
        ...
        bytes memory _message = Uint256MsgCodec.encode(ball);
        bytes memory options = combineOptions(_dstEid, Uint256MsgCodec.VANILLA_TYPE, _options);
    ...
    function quote(
        ...
        bytes memory payload = Uint256MsgCodec.encode(tempBall);
        bytes memory options = combineOptions(_dstEid, Uint256MsgCodec.VANILLA_TYPE, _options);
    ...
    function _lzReceive(
        ...
        uint256 oldBall = ball;
        uint256 value = Uint256MsgCodec.decode(payload);
        ball = value;
